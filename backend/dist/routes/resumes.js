...
<body>
  <div class="container">
    ...
    ${data.workExperience && data.workExperience.length > 0 && data.workExperience.some((j) => j.jobTitle || j.company)
            ? `
    <section>
      <h2>Work Experience</h2>
      ${data.workExperience
                .filter((job) => job.jobTitle || job.company)
                .map((job) => `
        <div class="entry">
    ...
    ${data.education && data.education.length > 0 && data.education.some((e) => e.school)
            ? `
    <section>
      <h2>Education</h2>
      ${data.education
    ...
    <section>
      ...
      <div class="skills-container">
        ${data.skills
                .map((skill) => `<div class="skill-item">${skill.name} <span style="color: #999;">• ${skill.level}</span></div>`)
                .join("")}
      </div>
    </section>
    `
